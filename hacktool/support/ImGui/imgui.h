...
enum ImGuiConfigFlags_
{
    ...
    ImGuiConfigFlags_TransparentBackbuffers = 1 << 11,  // Viewport enable flags (require both ImGuiBackendFlags_PlatformHasViewports + ImGuiBackendFlags_RendererHasViewports set by the respective backends)
...
struct ImGuiViewport
{
    ...
    bool                PlatformUseAlphaConpostion;
    ...
    bool GetAlphaCompotionProperty() const { return PlatformUseAlphaConpostion; }
    void SetAlphaCompotionProperty(const bool bEnableAlpha) { PlatformUseAlphaConpostion = bEnableAlpha; }
};
